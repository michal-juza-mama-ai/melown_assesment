...
class SegmentationDataset(VisionDataset):
    ...
    def __getitem__(self, index: int) -> Any:
        ...
        with open(image_path, "rb") as image_file, open(mask_path,
            ...
            # MJ we don't want to transform mask!
            transf = torchvision.transforms.PILToTensor()
            sample["mask"] = transf(sample["mask"])
            sample["mask"] = sample["mask"].type(torch.LongTensor)
